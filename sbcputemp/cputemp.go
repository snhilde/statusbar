...
// Color 1: Normal color, CPU temperature is cooler than 75 °C.
// Color 2: Warning color, CPU temperature is between 75 °C and 100 °C.
// Color 3: Error color, CPU temperature is hotter than 100 °C.
